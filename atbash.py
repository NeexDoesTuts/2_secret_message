...
class Atbash(Cipher):
    ...
    def __init__(self):
        ...
        # list comprehension to create alphabet list, more comments in Affine
        self.alphabet = [chr(i) for i in range(65, 91)]
        # and reversed one, more comments in Affine
        self.cipher_list = [chr(i) for i in range(90, 64, -1)]
